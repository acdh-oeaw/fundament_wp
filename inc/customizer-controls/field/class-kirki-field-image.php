...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'fundament_wp' ),
				'change'       => esc_attr__( 'Change image', 'fundament_wp' ),
				'default'      => esc_attr__( 'Default', 'fundament_wp' ),
				'remove'       => esc_attr__( 'Remove', 'fundament_wp' ),
				'placeholder'  => esc_attr__( 'No image selected', 'fundament_wp' ),
				'frame_title'  => esc_attr__( 'Select image', 'fundament_wp' ),
				'frame_button' => esc_attr__( 'Choose image', 'fundament_wp' ),
			)
		);
	}

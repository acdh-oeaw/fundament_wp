...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'fundament_wp' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'fundament_wp' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'fundament_wp' ),
			'200'       => esc_attr__( 'Light 200', 'fundament_wp' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'fundament_wp' ),
			'300'       => esc_attr__( 'Book 300', 'fundament_wp' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'fundament_wp' ),
			'400'       => esc_attr__( 'Normal 400', 'fundament_wp' ),
			'regular'   => esc_attr__( 'Normal 400', 'fundament_wp' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'fundament_wp' ),
			'500'       => esc_attr__( 'Medium 500', 'fundament_wp' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'fundament_wp' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'fundament_wp' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'fundament_wp' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'fundament_wp' ),
			'700'       => esc_attr__( 'Bold 700', 'fundament_wp' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'fundament_wp' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'fundament_wp' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'fundament_wp' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'fundament_wp' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'fundament_wp' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'fundament_wp' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'fundament_wp' ),
		);
	}

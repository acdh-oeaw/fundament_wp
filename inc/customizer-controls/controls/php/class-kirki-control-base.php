...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'fundament_wp' ),
				'remove'           => esc_attr__( 'Remove', 'fundament_wp' ),
				'default'          => esc_attr__( 'Default', 'fundament_wp' ),
				'selectFile'       => esc_attr__( 'Select File', 'fundament_wp' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'fundament_wp' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'fundament_wp' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'fundament_wp' ),
			)
		);

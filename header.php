...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
         <!-- ******************* Matomo Start ******************* -->
        <input type="hidden" name="matomoID" id="matomoID" value="<?=get_theme_mod( 'Matomo_ID' ); ?>" />
        <div id="cookie-overlay">
            <div class="container">
                <div class="cookie-message">
                    <p>This website uses cookies to ensure you get the best experience on our website. <a href="/imprint">More info</a></p>
                </div>
